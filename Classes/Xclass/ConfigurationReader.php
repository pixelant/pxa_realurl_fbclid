...
class ConfigurationReader extends \DmitryDulepov\Realurl\Configuration\ConfigurationReader
{
    ...
    protected $defaultValues = array(
        ...
        'cache/ignoredGetParametersRegExp' => '/^(?:gclid|hss_channel|utm_(?:source|medium|campaign|term|content)|fbclid|rdt_cid|pe_data|pk_campaign|pk_kwd|TSFE_ADMIN_PANEL.*)$/',
